...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spin = __webpack_require__(217);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/:id', component: _spin2.default })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spin = function (_Component) {
	  ...
	  function Spin(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Spin).call(this, props));
	  ...
	  _createClass(Spin, [{
	    ...
	    value: function tick() {
	      ...
	      if (this.state.seconds <= 0) {
	        var stage = this.state.stages[this.state.stage + 1];
	    ...
	    value: function componentDidMount() {
	      ...
	      _superagent2.default.get('/api/spin/' + this.props.params.id).set('Accept', 'application/json').end(function (err, res) {
	        if (err) return;
	        ...
	        var stage = _this2.state.stages[0];
	        _this2.setState({
	          seconds: stage.seconds,
	          text: stage.text,
	          stage: 0
	        });
	        _this2.interval = setInterval(_this2.tick.bind(_this2), 1000);
	      });
	    }
	  }, {
	    key: 'render',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h2',
	            null,
	            this.state.stages[this.state.stage + 1] ? this.state.stages[this.state.stage + 1].text : 'Done!'
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requestBase = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormData = __webpack_require__(223); // browserify compatible
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function _handleSave(e) {
	      ...
	      _superagent2.default.post('/api/spin').send({ stages: this.state.stages }).type('application/json').set('Accept', 'application/json').end(function (err, res) {
	        if (err) return;
	        _reactRouter.browserHistory.push('/' + res.body._id);
	      });
	    }
	  }, {
	    key: '_handleAdd',
	    value: function _handleAdd(e) {
	      ...
	      if (seconds.indexOf(':') > -1) {
	        var minutes = parseInt(seconds.split(':')[0]);
	      ...
	      (0, _reactDom.findDOMNode)(this.refs.textInput).focus();
	    }
	  }, {
	    key: '_onTimeChange',
	    value: function _onTimeChange(e) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'row stage-form' },
	          _react2.default.createElement('input', { ref: 'textInput', type: 'text', className: 'full', placeholder: 'Text', onChange: this._onTextChange, value: this.state.text }),
	          _react2.default.createElement('input', { ref: 'timeInput', type: 'text', className: 'full', placeholder: 'Time (seconds or minutes:seconds)', onChange: this._onTimeChange, value: this.state.seconds }),
	          _react2.default.createElement(
	            'button',
	            { onClick: this._handleAdd, className: 'full btn btn-add' },
	            'Add stage'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          this.state.stages.map(function (stage) {
	            return _react2.default.createElement(
	              'div',
	              { key: stage.index, className: 'stage-item text-center' },
	              _react2.default.createElement(
	                'p',
	                null,
	                stage.seconds,
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'row' },
	          function () {
	            if (_this2.state.stages.length) {
	              return _react2.default.createElement(
	                'button',
	                { onClick: _this2._handleSave, className: 'full btn btn-add spin-save' },
	                'Save'
	              );
	            }
	          }()
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@font-face {\n  font-family: \"Droid Sans\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"Droid Sans\"),local(DroidSans),url(//fonts.gstatic.com/s/droidsans/v6/s-BiyweUPV0v-yRb-cjciFQlYEbsez9cZjKsNMjLOwM.eot?#) format(\"eot\"),url(//fonts.gstatic.com/s/droidsans/v6/s-BiyweUPV0v-yRb-cjciPk_vArhqVIZ0nv9q090hN8.woff2) format(\"woff2\"),url(//fonts.gstatic.com/s/droidsans/v6/s-BiyweUPV0v-yRb-cjciBsxEYwM7FgeyaSgU71cLG0.woff) format(\"woff\");\n}\n\n@font-face {\n  font-family: \"Droid Sans\";\n  font-style: normal;\n  font-weight: 700;\n  src: local(\"Droid Sans Bold\"),local(DroidSans-Bold),url(//fonts.gstatic.com/s/droidsans/v6/EFpQQyG9GqCrobXxL-KRMWzklk6MJbhg7BmBP42CjCQ.eot?#) format(\"eot\"),url(//fonts.gstatic.com/s/droidsans/v6/EFpQQyG9GqCrobXxL-KRMYWiMMZ7xLd792ULpGE4W_Y.woff2) format(\"woff2\"),url(//fonts.gstatic.com/s/droidsans/v6/EFpQQyG9GqCrobXxL-KRMQFhaRv2pGgT5Kf0An0s4MM.woff) format(\"woff\");\n}\n\nbody {\n  font-family: 'Droid Sans', sans-serif;\n}\n\n.container {\n  width: 700px;\n  margin: 0 auto;\n}\n\n.row {\n  *zoom: 1;\n}\n\n.row:before {\n  content: '';\n  display: table;\n}\n\n.row:after {\n  content: '';\n  display: table;\n  clear: both;\n}\n\n.full {\n  width: calc(99.99% * 1 - (30px - 30px * 1));\n}\n\n.full:nth-child(1n) {\n  float: left;\n  margin-right: 30px;\n  clear: none;\n}\n\n.full:last-child {\n  margin-right: 0;\n}\n\n.full:nth-child(0n) {\n  margin-right: 0;\n  float: right;\n}\n\n.full:nth-child(0n + 1) {\n  clear: left;\n}\n\n.half {\n  width: calc(99.99% * 1/2 - (30px - 30px * 1/2));\n}\n\n.half:nth-child(1n) {\n  float: left;\n  margin-right: 30px;\n  clear: none;\n}\n\n.half:last-child {\n  margin-right: 0;\n}\n\n.half:nth-child(0n) {\n  margin-right: 0;\n  float: right;\n}\n\n.half:nth-child(0n + 1) {\n  clear: left;\n}\n\n.text-center {\n  text-align: center;\n}\n\n.logo {\n  font-size: 50pt;\n  color: #3498db;\n}\n\n.timer-text {\n  font-size: 280pt;\n  color: #3498db;\n  padding-bottom: 0;\n  margin-bottom: 20px;\n  margin-top: 60px;\n}\n\n.exercise-text {\n  font-size: 80pt;\n  margin-top: 10px;\n  margin-bottom: 10px;\n}\n\n.stage-form input {\n  padding: 10px;\n  border: 1px solid #e3e3e3;\n  font-size: 16pt;\n}\n\n.stage-form button {\n  font-weight: bold;\n  margin-right: 10px;\n  margin-left: 10px;\n  font-size: 16pt;\n}\n\n.btn {\n  padding: 10px;\n  border: 0;\n}\n\n.btn-add {\n  color: #fff;\n  background-color: #2ecc71;\n}\n\n.spin-save {\n  margin-top: 30px;\n  font-weight: bold;\n  margin-right: 10px;\n  margin-left: 10px;\n  font-size: 16pt;\n}\n\n.stage-list {\n  margin-top: 30px;\n}\n\n.stage-list .stage-item {\n  background-color: #fff;\n  padding: 5px;\n  font-size: 16pt;\n  margin-bottom: 10px;\n  border: 1px solid #e3e3e3;\n}\n\n.up-next {\n  font-size: 180%;\n}\n", ""]);
